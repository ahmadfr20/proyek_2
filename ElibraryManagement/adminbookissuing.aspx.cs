    ...
    public partial class adminbookissuing : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            if (checkIfBookExist() && checkIfMemberExist())
            {
                ...
                {
                    Response.Write("<script>alert('Member Sudah Meminjam Buku Ini');</script>");
                }
                else
                {
                    issueBook();
            ...
            {
                Response.Write("<script>alert('ID Buku atau ID Member Salah');</script>");
            }
        }
        // return book
        ...
        void returnBook()
        {
            try
            {
                ...
                if (result > 0)
                {
                    ...
                    Response.Write("<script>alert('Buku Telah Dikembalikan!');</script>");
                    GridView1.DataBind();
        ...
        void issueBook()
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@member_name", NamaMember.Text.Trim());
        ...
        void getNames()
        {
            try
            {
                ...
                if (dt.Rows.Count >= 1)
                {
                    NamaMember.Text = dt.Rows[0]["full_name"].ToString();
                }
                else
                {
                    Response.Write("<script>alert('ID Member Tidak Ditemukan!');</script>");
                }
