...
namespace ElibraryManagement
{
    public partial class adminbookinventory : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('ID Buku sudah terpakai, mohon untuk memakai ID lainnya');</script>");
            }
            else
            {
                addNewBook();
        ...
        void deleteBookByID()
        {
            if (checkIfBookExists())
            {
                try
                {
                    ...
                    cmd.ExecuteNonQuery();
                    con.Close();
                    Response.Write("<script>alert('Buku berhasil dihapus');</script>");
            ...
            {
                Response.Write("<script>alert('ID Buku Salah');</script>");
            }
        }
            ...
            if (checkIfBookExists())
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        {
                            Response.Write("<script>alert('Stok sebenarnya tidak boleh dimasukan kurang dari buku yang sedang dipinjam');</script>");
                            return;
                    ...
                    con.Close();
                    GridView1.DataBind();
                    Response.Write("<script>alert('Buku berhasil diperbarui');</script>");
        ...
        void addNewBook()
        {
            try
            {
                ...
                cmd.ExecuteNonQuery();
                con.Close();
                Response.Write("<script>alert('Buku berhasil ditambahkan.');</script>");
                GridView1.DataBind();
